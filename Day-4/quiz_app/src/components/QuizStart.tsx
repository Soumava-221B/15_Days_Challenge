                ...
                <div className="text-left bg-gray-50 p-6 rounded-xl max-w-2xl mx-auto">
                    <ul className="space-y-3 text-gray-700">
                        ...
                        <li className="flex items-start">
                            ...
                            <span>You have 5 Minutes to complete all the questions</span>
                        </li>
                        <li className="flex items-start">
                            ...
                            <span>Once you select an answer, you will see the explanation</span>
                        </li>
                        <li className="flex items-start">
                            ...
                            <span>You can navigate back to the previous questions</span>
                        </li>
                    </ul>
                </div>
            </div>
